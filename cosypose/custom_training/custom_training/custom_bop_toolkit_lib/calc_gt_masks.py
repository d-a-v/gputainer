# Adapted from https://github.com/thodan/bop_toolkit/blob/master/scripts/calc_gt_masks.py
...
from custom_training.custom_bop_toolkit_lib import dataset_params
from custom_training.custom_bop_toolkit_lib import renderer
from bop_toolkit_lib import inout
from bop_toolkit_lib import misc
from bop_toolkit_lib import visibility


def compute_gt_masks(p):
    ...
    for scene_id in scene_ids:
        ...
        for obj_id in dp_model['obj_ids']:
            ...
            ren.add_object(obj_id, model_tpath)
        ...
        for im_id in im_ids:
            ...
            for gt_id, gt in enumerate(scene_gt[im_id]):
                ...
                mask_visib_path = dp_split['mask_visib_tpath'].format(
                    scene_id=scene_id, im_id=im_id, gt_id=gt_id)
                inout.save_im(mask_visib_path, 255 *
                              mask_visib.astype(np.uint8))
