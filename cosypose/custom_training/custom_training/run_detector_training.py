...
from custom_training.custom_cosypose.training.train_detector import train_detector
...
if __name__ == '__main__':
    ...
    if 'custom' in args.config:
        from .cosypose_config import CUSTOM_DS_DIR
        ...
        if len(CUSTOM_CONFIG['test_ds_name']) > 0:
            cfg.test_ds_names = CUSTOM_CONFIG['test_ds_name']
